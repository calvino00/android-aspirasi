    ...
    public void onViewCreated(@NonNull final View view, @Nullable Bundle savedInstanceState) {
        ...
        btnBackToHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((AspirationActivity)getActivity()).finish();
//                FragmentAspirasi fragment = new FragmentAspirasi();
//                ((AspirationActivity)getActivity()).changeFragments(fragment);
                Intent i = new Intent(getActivity().getApplicationContext(), AspirationActivity.class);
                startActivity(i);
            }
        });
    }
